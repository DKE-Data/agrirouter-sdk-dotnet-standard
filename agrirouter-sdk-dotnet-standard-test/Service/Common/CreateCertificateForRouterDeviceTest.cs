...
{
    public class CreateCertificateForRouterDeviceTest
    {
        ...
        [Fact]
        public void MergeValidRouterDeviceAndCreateTheCertificate()
        {
            ...
            var certificate = X509CertificateService.GetCertificate(mergedOnboardResponse);
