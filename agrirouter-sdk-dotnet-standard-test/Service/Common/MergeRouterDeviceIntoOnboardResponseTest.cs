...
public class MergeRouterDeviceIntoOnboardResponseTest
{
    ...
    public void MergeValidRouterDeviceWithOnboardResponseShouldUpdateTheOnboardResponse()
    {
        ...
        Assert.NotEqual(routerDevice.Authentication.Certificate, originalOnboardResponse.Authentication.Certificate);
        Assert.NotEqual(routerDevice.ConnectionCriteria.ClientId, originalOnboardResponse.ConnectionCriteria.ClientId);
        ...
        Assert.Equal(routerDevice.ConnectionCriteria.GatewayId, originalOnboardResponse.ConnectionCriteria.GatewayId);
