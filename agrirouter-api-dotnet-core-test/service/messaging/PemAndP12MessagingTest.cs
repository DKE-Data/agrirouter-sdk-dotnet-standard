...
namespace com.dke.data.agrirouter.api.test.service.messaging
{
    public class PemAndP12MessagingTest : AbstractIntegrationTest
    {
        ...
        {
            RunWith(OnboardingResponseWithP12Certificate);
        }
        ...
        {
            RunWith(OnboardingResponseWithPEMCertificate);
        }

        private void RunWith(OnboardingResponse onboardingResponse)
        {
            var httpClient = HttpClientFactory.AuthenticatedHttpClient(onboardingResponse);
        ...
        private static OnboardingResponse OnboardingResponseWithP12Certificate
        {
            get
            {
        ...
        private static OnboardingResponse OnboardingResponseWithPEMCertificate
        {
            get
            {
                var onboardingResponseAsJson =
