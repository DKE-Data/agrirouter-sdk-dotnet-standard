...
namespace Agrirouter.Api.Test.Service.Messaging
{
    ...
    public class PublishMessageServiceTest : AbstractIntegrationTest
    {
        ...
        public void GivenValidMessageContentWhenPublishingMessageThenTheMessageShouldBeDelivered()
        {
            ...
            var publishMessageService =
                new PublishMessageService(new HttpMessagingService(HttpClientForSender), new EncodeMessageService());
